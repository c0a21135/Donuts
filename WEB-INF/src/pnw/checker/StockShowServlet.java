...
@WebServlet("/checker/StockShowServlet")
public class StockShowServlet extends HttpServlet {

    /**
     * @see HttpServlet#HttpServlet()
     */
    public StockShowServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "select s.donut_id, d.donut_name, d.donut_price, s.donut_stock from stock s join donuts d on (s.donut_id = d.donut_id)";
